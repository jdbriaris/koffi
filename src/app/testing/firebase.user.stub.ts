...
export class FirebaseUserStub implements User {
    ...
    linkWithCredential (credential: firebase.auth.AuthCredential ): firebase.Promise<any>{return null;}
    providerData: (firebase.UserInfo|null)[];
    reauthenticate(credential: firebase.auth.AuthCredential):firebase.Promise<any>{return null;}
    reauthenticateWithCredential (credential : firebase.auth.AuthCredential ) : firebase.Promise<any>{return null;}
    reauthenticateWithPopup (provider : firebase.auth.AuthProvider ) :  firebase.Promise<any>{return null;}
    reauthenticateWithRedirect (provider : firebase.auth.AuthProvider ) : firebase.Promise<any>{return null;}
    refreshToken: string;
    reload(): firebase.Promise<any>{return null;}
    sendEmailVerification(): firebase.Promise<any>{return null;}
    toJSON ( ) : Object{return null;}
